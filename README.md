...
Linux: [![Circle CI](https://circleci.com/gh/conda-forge/r-multitaper-feedstock.svg?style=shield)](https://circleci.com/gh/conda-forge/r-multitaper-feedstock)
OSX: [![TravisCI](https://travis-ci.org/conda-forge/r-multitaper-feedstock.svg?branch=master)](https://travis-ci.org/conda-forge/r-multitaper-feedstock)
Windows: [![AppVeyor](https://ci.appveyor.com/api/projects/status/github/conda-forge/r-multitaper-feedstock?svg=True)](https://ci.appveyor.com/project/conda-forge/r-multitaper-feedstock/branch/master)

Current release info
====================
Version: [![Anaconda-Server Badge](https://anaconda.org/conda-forge/r-multitaper/badges/version.svg)](https://anaconda.org/conda-forge/r-multitaper)
Downloads: [![Anaconda-Server Badge](https://anaconda.org/conda-forge/r-multitaper/badges/downloads.svg)](https://anaconda.org/conda-forge/r-multitaper)
